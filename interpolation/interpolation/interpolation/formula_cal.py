...
def cal_img_rotate():
	...
	res_width, res_height, dest_width, dest_height = symbols("res_width, res_height, dest_width, dest_height")
	angle, res_x, res_y, dest_x, dest_y = symbols("angle, res_x, res_y, dest_x, dest_y")
